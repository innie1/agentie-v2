...
class RoleNPCRegressionTests(unittest.TestCase):
    def setUp(self):
        self.cto={"id":"agt_cto","name":"Alex","role":"CTO","base":"general","purpose":"Lead engineering","skills":["code-execution"],"permissions":{"capability_mode":"explicit"}}
        self.writer={"id":"agt_writer","name":"Writer","role":"Content Writer","base":"general","purpose":"Create content","skills":[],"permissions":{"capability_mode":"explicit"}}
        self.researcher={"id":"agt_research","name":"Researcher","role":"Researcher","base":"general","purpose":"Research markets","skills":["research"],"permissions":{"capability_mode":"explicit"}}
        self.ceo={"id":"agt_ceo","name":"CEO","role":"CEO","base":"general","purpose":"Lead company","skills":[],"permissions":{"capability_mode":"explicit","delegate":True}}
    ...
    def test_local_profiles_follow_explicit_capabilities_not_job_titles(self):
        ...
        same_title_without_skill={**self.cto,"skills":[]}
        self.assertEqual(role_profile(same_title_without_skill),"general")

    def test_code_capability_handles_engineering_checklist_locally(self):
    ...
    def test_research_capability_handles_research_checklist_locally(self):
    ...
    def test_title_without_capability_does_not_create_hidden_local_class(self):
    ...
    def test_complex_capability_task_still_falls_back_to_provider(self):
