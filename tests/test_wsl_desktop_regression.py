...
class WSLDesktopRegressionTests(unittest.TestCase):
    ...
    def test_prepare_builds_kasmvnc_home_and_desktop_shortcuts(self):
        calls = []
    ...
    def test_start_script_uses_kasmvnc_and_keeps_cdp_optional(self):
        script = wsl_desktop._start_script()
        self.assertIn("vncserver :1 -select-de XFCE", script)
    ...
    def test_bootstrap_installs_kasmvnc_and_desktop_apps(self):
    ...
    def test_stop_kills_kasmvnc_and_optional_cdp_bridge(self):
