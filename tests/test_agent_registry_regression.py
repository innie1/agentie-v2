...
class AgentRegistryRegressionTests(unittest.TestCase):
    ...
    def test_create_agent_has_private_memory_and_session_namespace(self):
        ...
        self.assertTrue(agent["permissions"]["delegate"])
    ...
    def test_conversational_named_agent_creation_is_local(self):
        ...
        self.assertEqual(result["card"]["base"], "manager")
    ...
    def test_manager_relationship_builds_hierarchy(self):
