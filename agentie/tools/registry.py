...
TOOLSETS = {
    "general": [get_current_utc_time, search_web, read_text_file, write_text_file, list_workspace_files, edit_text_file, run_python, remember, recall_memory, list_memories, *TASK_TOOLS, http_get, request_approval, list_approvals],
    "research": [get_current_utc_time, search_web, http_get, read_text_file, write_text_file, list_workspace_files, remember, recall_memory, list_memories, *TASK_TOOLS],
    "coding": [get_current_utc_time, read_text_file, write_text_file, list_workspace_files, edit_text_file, run_python, github_repo_info, github_read_file, *TASK_TOOLS, request_approval, list_approvals],
    "manager": [get_current_utc_time, remember, recall_memory, list_memories, *TASK_TOOLS, request_approval, list_approvals],
