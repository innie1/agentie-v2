...
(()=>{
  ...
  const style=document.createElement('style');style.textContent=`.agent-copy strong{display:flex!important;align-items:center;gap:6px}.agent-role-tag{display:inline-flex;max-width:112px;padding:2px 6px;border:1px solid var(--border);border-radius:999px;background:var(--soft);color:var(--muted);font-size:9px;font-weight:650;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}.agent-last-message{font-size:10px!important;color:var(--muted);margin-top:3px!important}.agent-edit{border:0;background:transparent;color:var(--muted);cursor:pointer;padding:4px;border-radius:7px}.agent-edit:hover{background:var(--soft);color:var(--text)}.agent-handoff-card{width:min(520px,92vw)}.agent-handoff-flow{display:flex;align-items:center;gap:8px;margin-top:10px}.agent-handoff-person{display:flex;align-items:center;gap:7px;min-width:0}.agent-handoff-orb{width:27px;height:27px;border-radius:50%;display:grid;place-items:center;font-size:8px;font-weight:800;color:#111;flex:none}.agent-handoff-arrow{color:var(--muted);font-size:15px}.agent-handoff-role{font-size:10px;color:var(--muted)}.agent-handoff-status{margin-top:10px;padding:8px 9px;border-radius:9px;background:var(--soft);font-size:11px;color:var(--muted)}`;document.head.appendChild(style);
